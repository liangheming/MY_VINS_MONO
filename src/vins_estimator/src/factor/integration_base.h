...
public:
                             ...
                             Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        result_delta_q = Eigen::Quaterniond(delta_q.toRotationMatrix() * Utility::Exp(un_gyr * dt));
        ...
        if (update_jacobian)
        {
            ...
            double dt_2 = _dt * _dt, dt_3 = _dt * _dt * _dt;
            ...
            // MatrixXd F = MatrixXd::Index(15, 15);
            ...
            F.block<3, 3>(0, 3) = -0.25 * dt_2 * (result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::Exp(-w_x * _dt) + delta_q.toRotationMatrix() * Utility::skewSymmetric(a_0_x));
            F.block<3, 3>(0, 6) = Matrix3d::Identity() * _dt;
            F.block<3, 3>(0, 9) = -0.25 * dt_2 * (delta_q.toRotationMatrix() + result_delta_q.toRotationMatrix());
            F.block<3, 3>(0, 12) = 0.25 * dt_3 * result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::rightJacobian(w_x * _dt);
            F.block<3, 3>(3, 3) = Utility::Exp(-w_x * _dt);
            F.block<3, 3>(3, 12) = -_dt * Utility::rightJacobian(w_x * _dt);
            F.block<3, 3>(6, 3) = -0.5 * _dt * (result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::Exp(-w_x * _dt) + delta_q.toRotationMatrix() * Utility::skewSymmetric(a_0_x));
            F.block<3, 3>(6, 9) = -0.5 * _dt * (delta_q.toRotationMatrix() + result_delta_q.toRotationMatrix());
            F.block<3, 3>(6, 12) = 0.5 * dt_2 * result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::rightJacobian(w_x * _dt);
            ...
            Matrix<double, 15, 18> V = Matrix<double, 15, 18>::Zero();
            V.block<3, 3>(0, 0) = -0.25 * dt_2 * delta_q.toRotationMatrix();
            V.block<3, 3>(0, 3) = 0.125 * dt_3 * result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::rightJacobian(w_x * _dt);
            V.block<3, 3>(0, 6) = -0.25 * dt_2 * result_delta_q.toRotationMatrix();
            V.block<3, 3>(0, 9) = V.block<3, 3>(0, 3);
            V.block<3, 3>(3, 3) = -0.5 * _dt * Utility::rightJacobian(w_x * _dt);
            V.block<3, 3>(3, 9) = -0.5 * _dt * Utility::rightJacobian(w_x * _dt);
            V.block<3, 3>(6, 0) = -0.5 * _dt * delta_q.toRotationMatrix();
            V.block<3, 3>(6, 3) = 0.25 * dt_2 * result_delta_q.toRotationMatrix() * Utility::skewSymmetric(a_1_x) * Utility::rightJacobian(w_x * _dt);
            V.block<3, 3>(6, 6) = -0.5 * _dt * result_delta_q.toRotationMatrix();
            V.block<3, 3>(6, 9) = V.block<3, 3>(6, 3);
